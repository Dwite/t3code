...
export const ClientSettingsSchema = Schema.Struct({
  ...
  voiceInputSendImmediately: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  voiceInputSendImmediately: Schema.optionalKey(Schema.Boolean),
